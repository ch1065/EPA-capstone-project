...
data = pd.read_csv('data/final_1.2.csv').drop(['Relative Humidity  (Percent relative humidity)', \
...
class_5 = sub[sub['Exceedance'] == 5]
class_4 = sub[sub['Exceedance'] == 4]
class_3 = sub[sub['Exceedance'] == 3]
class_2 = sub[sub['Exceedance'] == 2]
...
plt.bar(['0', '1', '2', '3', '4', '5'], [len(class_0), len(class_1), len(class_2), len(class_3), len(class_4), len(class_5)])
plt.title('Distribution of Ozone Hourly AQI')
plt.ylabel('Frequency')
#plt.show()

# +++++++++++++++++++++++++++++++ NEED TO IMPLEMENT SMOTE +++++++++++++++++++++++++++++++
