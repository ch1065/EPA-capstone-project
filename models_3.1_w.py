...
df_decomposed_add = seasonal_decompose(sub['Ozone (Parts per million)_x'], model='additive', period = 24) #4320
...
hwes = ExponentialSmoothing(train['Ozone (Parts per million)_x'], trend = 'mul', seasonal = 'mul', seasonal_periods = 24)
