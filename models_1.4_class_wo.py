...
# removing nas and features not needed
...
def preformance(x_train, y_train, x_test, y_test, mod, set):
    ...
    set: defining the dataset being used to run the model--imbalanced vs balanced 

    function that calculates the preformance (using F1 score) of the model on both training and test sets
    """
    # used to define the difference between the imbalanced and balanced datasets 
    print(set)
